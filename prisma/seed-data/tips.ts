...
export const TIPS: TipSeed[] = [
  ...
  {
    slug: "five-common-grammar-mistakes",
    title: "5 Common Grammar Mistakes to Avoid",
    topic: "Grammar",
    tags: ["tips", "grammar", "writing", "exam-strategy"],
    data: {
      readMinutes: 6,
      excerpt:
  ...
  {
    slug: "how-examiners-mark-speaking",
    title: "How examiners mark Speaking",
    topic: "Speaking",
    tags: ["tips", "speaking", "band-descriptors"],
    data: {
      readMinutes: 8,
      excerpt:
  ...
  {
    slug: "task-2-thesis-statement",
    title: "Task 2: building a strong thesis",
    topic: "Writing",
    tags: ["tips", "writing", "task-2", "exam-strategy"],
    data: {
      readMinutes: 6,
  ...
  {
    slug: "listening-section-4-note-taking-tips",
    title: "Listening Section 4: note-taking",
    topic: "Listening",
    tags: ["tips", "listening", "exam-strategy"],
    data: {
      readMinutes: 7,
