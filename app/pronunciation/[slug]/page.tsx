    ...
    <main className="flex flex-1 flex-col bg-surface">
      <div className="mx-auto w-full max-w-2xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="text-center">
          <p className="text-6xl font-bold text-link">/{drill.symbol}/</p>
          <h1 className="mt-3 text-lg font-semibold text-ink">{drill.title}</h1>
          <p className="mt-1 text-xs uppercase tracking-wide text-ink-muted">{drill.kind}</p>
        ...
        <Section title="How to make the sound">
          <p className="text-sm leading-relaxed text-ink-body">{drill.howTo}</p>
        </Section>
        ...
        <Section title="Practice sentence">
          <p className="mb-3 rounded-xl border border-line bg-surface-muted p-4 text-base leading-relaxed text-ink">
            {drill.sentence}
          </p>
          <div className="flex flex-wrap gap-2">
        ...
        <Section title="Tip">
          <p className="border-l-2 border-brand-200 pl-4 text-sm leading-relaxed text-ink-body">
            {drill.tip}
          </p>
        </Section>
